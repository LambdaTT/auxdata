...
class CreateTableKinship extends Migration
{
  public function apply()
  {
    if (!$this->isEntityAllowed('kinship')) return;

    $this->Table('AUX_KINSHIP')
      ->id('id_aux_kinship') // int primary key auto increment
      ->string('ds_key', 17)
