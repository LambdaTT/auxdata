...
class CreateTableEmploymentStatus extends Migration
{
  public function apply()
  {
    if (!$this->isEntityAllowed('maritalstatus')) return;

    $this->Table('AUX_EMPLOYMENTSTATUS')
      ->id('id_aux_employmentstatus') // int primary key auto increment
      ->string('ds_key', 17)
